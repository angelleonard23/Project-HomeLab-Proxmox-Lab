...
3. [Status & Screenshots](#status--screenshots)
4. [Netzwerk-Topologie](#netzwerk-topologie)
5. [Dokumentation Phase 1: pfSense Firewalling & VLAN Webserver](#dokumentation-phase-1-pfsense-firewalling--vlan-webserver)
   1. [Proof of Concept](#proof-of-concept)
   2. [Security-Hardening: pfBlockerNG Integration](#security-harding-pfblockerng-integration)
   3. [Deployment des Web-Services](#deployment-des-web-services)
6. [Infrastruktur Komponente: Webserver-01](#infrastruktur-komponente-webserver-01)
7. [Firewall & NAT: Externer Zugriff](#firewall--nat-externer-zugriff)
8. [Architektur & Topologie](#architektur--topologie)
9. [Security & Konfiguration](#security--konfiguration)
10. [Monitoring & Performance](#monitoring--performance)
11. [Einrichtung VLAN 20 & DMZ Isolierung](#einrichtung-vlan-20--dmz-isolierung)
12. [SSH Security & Hardening](#ssh-security--hardening)
13. [Datenbank-Setup & PHP-Anbindung](#datenbank-setup--php-anbindung)
...
16. [Backup-Automatisierung (Cron & Skripte)](#backup-automatisierung-cron--skripte)
